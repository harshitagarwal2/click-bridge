...
| Relay HTTP/WebSocket server | **Written**, 14 socket tests pending `npm install` |
...
104 Node tests pass; 14 skip until `ws` is installed. Nothing Swift has been
built — no macOS was available where this was written.
